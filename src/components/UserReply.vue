<template>
  ...
  <div v-else class="user-reply__container d-flex flex-column">
    ...
    <div class="user-reply__container__tweet d-flex">
      <button class="user-reply__container__tweet__icon">
        <img
      ...
      <button
        ...
        class="user-reply__container__tweet__icon"
      >
    ...
    <div class="user-reply__container__reply-list scrollbar">
      <div
        v-if="!replies.length"
        class="user-reply__container__tweet-list__blank"
      >
        目前沒有回覆
      </div>
      <div
        ...
        :key="reply.id"
        class="user-reply__container__tweet-list__tweet d-flex"
      >
        <router-link :to="{ name: 'profile', params: { id: reply.User.id } }">
          <img
            :src="reply.User.avatar | emptyImage"
            class="user-reply__container__tweet-list__tweet__avatar"
            alt=""
          />
        </router-link>
        <div
          class="user-reply__container__tweet-list__tweet__text d-flex flex-column"
        >
          <div class="d-flex justify-content-between">
            ...
            <button
              ...
              class="user-reply__container__tweet-list__tweet__delete__reply"
              :disabled="isProcessing"
          ...
          <div
            class="user-reply__container__tweet-list__tweet__text__reply d-flex"
          >
          ...
          <div
            class="user-reply__container__tweet-list__tweet__text__description"
          >
            {{ reply.comment }}
          </div>
        </div>
